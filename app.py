...
def display_results(container: ui.column, results_dict: Dict[str, Any], job_title_original: str):
    ...
    with container:
        ...
        with ui.row().classes('w-full items-baseline'): # Syntaxe corrigée
        ...
        with ui.row().classes('w-full mt-4 gap-4 flex-wrap'): # Syntaxe corrigée
        ...
        with ui.row().classes('w-full justify-center items-center gap-2 mt-4'): # Syntaxe corrigée
